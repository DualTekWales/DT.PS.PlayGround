...
#>
   ...
   if ($repetitionInterval -and $null -ne $trigger.Repetition) 
   {
      $trigger.Repetition.Interval = $repetitionInterval;
   }
   if ($repetitionDuration -and $null -ne $trigger.Repetition) 
   {
      $trigger.Repetition.Duration = $repetitionDuration;
   }
   if ($stopAtDurationEnd -and $null -ne $trigger.Repetition) 
   {
